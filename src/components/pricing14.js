      ...
      <div className="pricing14-max-width thq-section-max-width">
        <div className="pricing14-section-title">
            ...
            {props.content1 ?? (
              <Fragment>
                <span className="pricing14-text178">
                  Pilih paket rental yang sesuai kebutuhanmu
                </span>
              </Fragment>
            )}
          </span>
          <div className="pricing14-content">
            <h2 className="pricing14-text101 thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="pricing14-text180">Paket Harga Rental</span>
                </Fragment>
              )}
            </h2>
              ...
              {props.content2 ?? (
                <Fragment>
                  <span className="pricing14-text202">
                    Dapatkan perlengkapan outdoor terbaik dengan harga terjangkau. Pilih paket harian atau tahunan sesuai kebutuhan petualanganmu!
                  </span>
                </Fragment>
              )}
            </p>
        ...
        <div className="pricing14-tabs">
          {isMonthly === true && (
            ...
            >
              <span className="thq-body-small">Harian</span>
            </button>
          )}
          {isMonthly === false && (
            <button
          ...
          {isMonthly === false && (
            ...
            >
              <span className="thq-body-small">Tahunan</span>
            </button>
          )}
          {isMonthly === true && (
            <button
            ...
            <div className="pricing14-column1 thq-card">
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  <p className="pricing14-text107 thq-body-large">
                    {props.plan1 ?? (
                      <Fragment>
                        <span className="pricing14-text182">Paket Basic</span>
                      </Fragment>
                    )}
                  </p>
                  <h3 className="pricing14-text108 thq-heading-3">
                    {props.plan1Price ?? (
                      <Fragment>
                        <span className="pricing14-text204">Rp 150.000 / hari</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan1Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text199">Rp 1.500.000 / tahun</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing14-list1">
                  ...
                  <div className="pricing14-list-item12">
                    ...
                    <span className="thq-body-small">
                      {props.plan1Feature3 ?? (
                        <Fragment>
                          <span className="pricing14-text198">Senter</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
              ...
              <button className="pricing14-button14 thq-button-outline thq-button-animated">
                <span className="thq-body-small">
                  {props.plan1Action ?? (
                    <Fragment>
                      <span className="pricing14-text158">Sewa Sekarang</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column2 thq-card">
              <div className="pricing14-price12">
                <div className="pricing14-price13">
                  ...
                  <h3 className="pricing14-text115 thq-heading-3">
                    {props.plan2Price ?? (
                      <Fragment>
                        <span className="pricing14-text188">Rp 250.000 / hari</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan2Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text168">Rp 2.500.000 / tahun</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing14-list2">
                  ...
                  <div className="pricing14-list-item16">
                    ...
                    <span className="thq-body-small">
                      {props.plan2Feature4 ?? (
                        <Fragment>
                          <span className="pricing14-text167">Lentera</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
              ...
              <button className="pricing14-button15 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan2Action ?? (
                    <Fragment>
                      <span className="pricing14-text170">Sewa Sekarang</span>
                    </Fragment>
                  )}
                </span>
              </button>
            ...
            <div className="pricing14-column3 thq-card">
              <div className="pricing14-price14">
                <div className="pricing14-price15">
                  ...
                  <h3 className="pricing14-text123 thq-heading-3">
                    {props.plan3Price ?? (
                      <Fragment>
                        <span className="pricing14-text155">Rp 350.000 / hari</span>
                      </Fragment>
                    )}
                  </h3>
                  <p className="thq-body-large">
                    {props.plan3Yearly ?? (
                      <Fragment>
                        <span className="pricing14-text194">Rp 3.500.000 / tahun</span>
                      </Fragment>
                    )}
                  </p>
                </div>
                <div className="pricing14-list3">
                  ...
                  <div className="pricing14-list-item20">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature4 ?? (
                        <Fragment>
                          <span className="pricing14-text195">Cooler box</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
              ...
              <button className="pricing14-button16 thq-button-animated thq-button-filled">
                <span className="thq-body-small">
                  {props.plan3Action ?? (
                    <Fragment>
                      <span className="pricing14-text156">Sewa Sekarang</span>
                    </Fragment>
                  )}
                </span>
              </button>
                  ...
                  <div className="pricing14-list-item24">
                    ...
                    <span className="thq-body-small">
                      {props.plan1Feature31 ?? (
                        <Fragment>
                          <span className="pricing14-text197">Backpack</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                  ...
                  <div className="pricing14-list-item31">
                    ...
                    <span className="thq-body-small">
                      {props.plan3Feature31 ?? (
                        <Fragment>
                          <span className="pricing14-text181">GPS device</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
